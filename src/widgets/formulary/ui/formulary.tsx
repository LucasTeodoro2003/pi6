                ...
                <div className="space-y-6 bg-white dark:bg-gray-700 px-4 py-5 sm:p-6">
                  <div>
                    ...
                    <div className="mx-auto flex items-center justify-center">
                      <span className="inline-block h-24 w-24 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800">
                        <svg
                    ...
                    <div className="mt-4">
                      <div className="flex justify-center rounded-md border-2 border-dashed border-gray-300 dark:border-gray-600 px-60 pt-5 pb-6">
                        <div className="space-y-1 text-center">
                          ...
                          <p className="text-xs text-gray-500 dark:text-white">PNG, JPG, GIF até 10MB</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  <label htmlFor="obs" className="mt-4 block text-sm font-medium text-gray-700 dark:text-white">
                    Observações
                  </label>
                  <div className="mt-1">
                    <textarea
                      ...
                      name="obs"
                      rows={3}
                      className="dark:text-white dark:bg-gray-700 mt-1 block w-full rounded-md border-gray-300 dark:border-gray-400 shadow-sm dark:shadow-white focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                      defaultValue={''}
                    />
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <input
                        ...
                        className="mt-1 block h-7 w-full rounded-md dark:bg-gray-700 border-gray-300 dark:shadow-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-white"
                      />
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <input
                        ...
                        id="email"
                        autoComplete="email"
                        className="mt-1 block h-7 w-full rounded-md dark:bg-gray-700 border-gray-300 shadow-sm dark:shadow-white focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-white"
                      />
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <select
                        ...
                        className="mt-1 block w-full rounded-md border border-gray-300 bg-white dark:bg-gray-700 py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm font-Jakarta dark:text-white"
                      >
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                    ...
                    <div className="col-span-6">
                      <label htmlFor="departament" className="block text-sm font-medium text-gray-700 dark:text-white">
                        Departamento
                      </label>
                      <input
                        type="text"
